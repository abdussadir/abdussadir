...
<!-- Self-hosted: generated by .github/workflows/stats-cards.yml from the live GitHub API,
     so this never depends on a third-party rendering service being up. -->
<img src="./assets/stats-card.svg" alt="GitHub stats" height="170">
<img src="./assets/langs-card.svg" alt="Top languages" height="170">
